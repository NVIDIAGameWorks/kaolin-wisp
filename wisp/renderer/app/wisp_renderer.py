...
from wisp.renderer.core.render_core import RendererCore
...
from wisp.renderer.gizmos.ogl.world_grid import WorldGrid
from wisp.renderer.gizmos.ogl.axis_painter import AxisPainter
from wisp.renderer.gizmos.ogl.primitives_painter import PrimitivesPainter
...
from wisp.framework.event import watch
...
class WispRenderer(ABC):
    ...
    @staticmethod
    def _create_cugl_shared_texture(res_h, res_w, channel_depth, map_flags=graphics_map_flags.WRITE_DISCARD,
                                    dtype=np.uint8):
