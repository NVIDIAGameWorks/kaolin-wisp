...
from wisp.renderer.core.bottomlevel import *
from wisp.renderer.core.bottomlevel.bl_renderers import BottomLevelRenderer, RayTracedRenderer
from wisp.models.nefs import BaseNeuralField
from wisp.core.pipeline import Pipeline
...
def _neural_field_to_renderer_cls(pipeline: Pipeline) -> Type[RayTracedRenderer]:
    ...
    while type_queue:
        ...
        if renderer_cls is not None:
            break
        else:   # Try querying all parent(nef) + tracer combos for compatability
