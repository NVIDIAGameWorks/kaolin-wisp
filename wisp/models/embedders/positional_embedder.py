...
def get_positional_embedder(multires, active, input_dim=3):
    """Utility function to get the embedding from the NeRF-style multires input.

    TODO(ttakikawa): Multires doesn't make much sense to me...
    ...
    if not active:
        ...
        encoder = PositionalEmbedder(multires, multires-1, input_dim=input_dim)
